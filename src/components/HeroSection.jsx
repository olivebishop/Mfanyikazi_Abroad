    ...
    <section className="bg-black">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 mt-6">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <Link
            to="/signup"
            className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-500 hover:bg-slate-500 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 no-underline"
          >
            Get started
